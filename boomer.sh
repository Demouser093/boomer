...
zipfinder(){
    ...
    grep -E '\.(zip|bak|tar|tar\.gz|tgz|7z|rar|sql|db|backup|old|gz|bz2|log|ini|conf|config|env|yml|yaml|xml|json|csv|txt|pem|key|crt|cer|pfx|p12|jks|ppk|rdp|vmdk|ova|ovf|vhd|vhdx|iso|dmg|img|bin|exe|msi|bat|sh|bash|ps1|py|php|asp|aspx|jsp|js|jar|war|ear|dat|bak|swp|swo|sav|save|tmp|temp|pid|lock|dump|back|backup[0-9]*|archive|copy|orig|test|dev|staging|prod|secret|private|passwd|shadow|htpasswd|htaccess|gitignore|gitconfig|gitattributes|dockerfile|dockerignore|vagrantfile|vagrantignore|travis.yml|circleci|jenkinsfile|makefile|cmake|gradle|maven|pom.xml|build.xml|ant.xml|ivy.xml|settings.xml|web.xml|struts.xml|spring.xml|beans.xml|applicationContext.xml|persistence.xml|faces-config.xml|navigation.xml|web-inf|meta-inf|bin|obj|pdb|lib|dll|so|a|o|class|pyc|pyo|pyd|rbc|gem|gemspec|lockfile|vendor|bundle|node_modules|package.json|package-lock.json|bower.json|bowerrc|npmrc|yarnrc|yarn.lock|composer.json|composer.lock|phpunit.xml|phpunit.xml.dist|phpcs.xml|phpcs.xml.dist|phpmd.xml|phpmd.xml.dist|phpstan.neon|phpstan.neon.dist|psalm.xml|psalm.xml.dist|phpdoc.xml|phpdoc.xml.dist|phpunit-bridge.xml|phpunit-bridge.xml.dist|phpunit-bridge.php|phpunit-bridge.php.dist|phpunit-bridge.yml|phpunit-bridge.yml.dist|phpunit-bridge.yaml|phpunit-bridge.yaml.dist|phpunit-bridge.ini|phpunit-bridge.ini.dist|phpunit-bridge.json|phpunit-bridge.json.dist|phpunit-bridge.neon|phpunit-bridge.neon.dist|phpunit-bridge.xml|phpunit-bridge.xml.dist|phpunit-bridge.php|phpunit-bridge.php.dist|phpunit-bridge.yml|phpunit-bridge.yml.dist|phpunit-bridge.yaml|phpunit-bridge.yaml.dist|phpunit-bridge.ini|phpunit-bridge.ini.dist|phpunit-bridge.json|phpunit-bridge.json.dist|phpunit-bridge.neon|phpunit-bridge.neon.dist)$')
